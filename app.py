...
def requested():
    ...
    phone=[]
    for i in a:
        url="https://www.fast2sms.com/dev/bulkV2?authorization=902ueKral5vcjfxmiIyz6sB4ZwOQNFXnJMHPSW1A8pg3ECVkGoPiGkZsdWxb3vMrR8tJpcBfEF0ToqeA&sender_id=TXTIND&message=Need plasma of your Blood group call toll free no 040-23554849&language=english&route=v3&numbers="+str(i['phone'])
